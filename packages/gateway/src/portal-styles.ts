...
export const PORTAL_STYLES = `
      ...
      * { box-sizing: border-box; }
      ...
      .page-background-layout .hero-stage { padding: 0 0 8px; }
      .page-background-layout .stage { width: 100vw; max-width: none; }
      .portal-scroll.page-background-layout .project-deck { top: 65%; }
      .page-background-layout .overflow-section { margin-top: -120px; }
`;
